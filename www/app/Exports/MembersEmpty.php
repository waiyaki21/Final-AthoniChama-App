...
class MembersEmpty implements FromView, WithEvents, WithColumnWidths, WithStyles, WithProperties, ShouldAutoSize, WithColumnFormatting
{
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getColumnDimension('C')->setCollapsed(false)->setVisible(true)->setWidth(20);
        $sheet->getColumnDimension('D')->setCollapsed(false)->setVisible(true)->setWidth(20);
        $sheet->getColumnDimension('E')->setCollapsed(false)->setVisible(true)->setWidth(20);
        $sheet->getColumnDimension('F')->setCollapsed(false)->setVisible(true)->setWidth(20);
        $sheet->getColumnDimension('G')->setCollapsed(false)->setVisible(true)->setWidth(20);
    }
